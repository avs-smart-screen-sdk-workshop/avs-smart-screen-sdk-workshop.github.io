...
`-C /home/pi/sdk-folder/sdk-build/Integration/AlexaClientSDKConfig.json` - specifies a configuration of our Alexa Client, such as our device security profile, device ID, etc 
